...
- **Reports** — progress summaries generated by `questio-report`, persisted as dated markdown files
- **Presentations** — slide decks for lab meetings, conferences, or talks
...
See [Deliverables Convention](../deliverables.md) for the full spec.
