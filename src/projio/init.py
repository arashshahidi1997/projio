...
def _gitignore_entries_for_framework(site_framework: str) -> list[str]:
    entries = [
        ...
        # biblio
        ".projio/biblio/logs/",
        # codio mirrors (shallow reference clones)
        ".projio/codio/mirrors/",
        # render artefacts (generated by projio sync / biblio_compile)
        ".projio/render/pandoc-defaults.yaml",
        ".projio/render/compiled.bib",
        # filters (copied by projio sync)
        ".projio/filters/",
        # pipeio (run state, snakemake cache, jupytext-paired notebooks)
        ".pipeio/runs.json",
        ".snakemake/",
        "*.ipynb",
        ".ipynb_checkpoints/",
