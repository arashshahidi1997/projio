...
name: questio-record
description: >
  Guided evidence and observation capture. Handles two modes: result notes
  for milestone evidence (structured frontmatter with question, milestone,
  metric, confidence) and observation notes for mid-loop findings.
metadata:
  short-description: capture research evidence and mid-loop observations
  tags: [questio, record, evidence, notes]
  tooling:
    mcp:
      - server: projio
        tools:
